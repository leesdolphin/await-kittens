...
class FlickrHelper():
    ...
    def get_photo_data(self, raw_photo_info_resp):
        """
        ...
        license = self.get_photo_license(data_photo['license'])
        data = dict(
    ...
    def get_photo_license(self, license_id):
        licenses = {
    ...
    def get_image_url_from_sizes(self, raw_photo_sizes_resp):
